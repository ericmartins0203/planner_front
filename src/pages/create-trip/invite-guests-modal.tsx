        ...
        <div className="flex flex-wrap gap-2">
          {emailsToInvite.map((email, index) => {
            return (
              <div
                key={index}
                className="py-1.5 px-2.5 bg-zinc-800 flex items-center gap-2"
              >
          ...
          <form
            ...
            className="p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2 w-full"
          >
